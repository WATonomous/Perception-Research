...
class CarlaWorld:
    def __init__(self, HDF5_file, world='Town04'):
    ...
    def begin_data_acquisition(self, sensor_width, sensor_height, fov, frames_to_record_one_ego=1, timestamps=[], egos_to_run=10, fps=10):
        ...
        with CarlaSyncMode(self.world, self.rgb_camera, self.depth_camera, fps=fps) as sync_mode:
