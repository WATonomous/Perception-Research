...
Model weights have been downloaded from: https://drive.google.com/file/d/18fy-6beTFTZx5SrYLs9Xk7cY-fGSm7kw/view and copied into `/mnt/scratch/lss/pretrained.pt`

Getting started
```
docker compose up lss
```

In a new terminal, run
```
docker exec -it perception-research-lss-1 /bin/bash
```

Install the dependencies (todo: add to Dockerfile)
```
...
```bash
cd /lift-splat-shoot
python main.py eval_model_iou trainval --modelf=/lss/pretrained.pt --dataroot=/nuscenes
```

Visualize Predictions
```
python main.py viz_model_preds trainval --modelf=/lss/pretrained.pt --dataroot=/nuscenes --map_folder=/nuscenes
```
